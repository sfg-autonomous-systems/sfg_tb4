...
2. Configure the following settings via the Create 3's web-interface. Note that any other setting will be automatically configured once below settings are active.
